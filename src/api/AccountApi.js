...
export class AccountApi {
    ...
    */
     ...
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
    apiAccountIdBalanceCreditPost(id, apiVersion, authorization, fMessageId, fOrigin, opts, callback) {
      opts = opts || {};
      let postBody = opts['body'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = DepositViewModelV2ValidResponsePackage;

      return this.apiClient.callApi(
        '/api/Account/{Id}/Balance/Credit', 'POST',
        pathParams, queryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
    ...
    apiAccountIdTransactionsGet(id, startDate, endDate, apiVersion, authorization, fMessageId, fOrigin, opts, callback) {
      ...
      let queryParams = {
        'StartDate': startDate,'EndDate': endDate,'SettlementsOnly': opts['settlementsOnly'],'Currency': opts['currency'],'TradeWallet': opts['tradeWallet'],'WalletId': opts['walletId'],'CardOnly': opts['cardOnly'],'PageNo': opts['pageNo'],'PageSize': opts['pageSize'],'NewestFirst': opts['newestFirst']
      };
      let headerParams = {
        'api-version': apiVersion,'Authorization': authorization,'F-Message-Id': fMessageId,'F-Origin': fOrigin
      };
