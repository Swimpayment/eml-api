...
import {MDESTransaction} from './MDESTransaction';
 ...
 * @version 2.0
 */
export class TokenTransactionsViewModel {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('transactions'))
        obj.transactions = ApiClient.convertToType(data['transactions'], [MDESTransaction]);
    }
    return obj;
  }
}
