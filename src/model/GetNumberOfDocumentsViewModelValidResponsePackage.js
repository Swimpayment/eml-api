...
import {GetNumberOfDocumentsViewModel} from './GetNumberOfDocumentsViewModel';
 ...
 * @version 2.0
 */
export class GetNumberOfDocumentsViewModelValidResponsePackage {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = GetNumberOfDocumentsViewModel.constructFromObject(data['data']);
