...
import {GetRiskLevelViewModel} from './GetRiskLevelViewModel';
 ...
 * @version 2.0
 */
export class GetRiskLevelViewModelValidResponsePackage {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = GetRiskLevelViewModel.constructFromObject(data['data']);
