...
import {MccBlockViewModel} from './MccBlockViewModel';
 ...
 * @version 2.0
 */
export class MccBlockViewModelValidResponsePackage {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = MccBlockViewModel.constructFromObject(data['data']);
