...
import {InquiryBalanceV2ViewModel} from './InquiryBalanceV2ViewModel';
...
export class CardV2ViewModel {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('accountBaseCurrency'))
        obj.accountBaseCurrency = ApiClient.convertToType(data['accountBaseCurrency'], 'String');
      ...
      if (data.hasOwnProperty('pinTriesExceeded'))
        obj.pinTriesExceeded = ApiClient.convertToType(data['pinTriesExceeded'], 'String');
      if (data.hasOwnProperty('badPinTries'))
        obj.badPinTries = ApiClient.convertToType(data['badPinTries'], 'String');
      if (data.hasOwnProperty('expirationDate'))
        obj.expirationDate = ApiClient.convertToType(data['expirationDate'], 'String');
      if (data.hasOwnProperty('cardEffectiveEnd'))
        obj.cardEffectiveEnd = ApiClient.convertToType(data['cardEffectiveEnd'], 'String');
      if (data.hasOwnProperty('client'))
        obj.client = ApiClient.convertToType(data['client'], 'String');
      if (data.hasOwnProperty('phoneCardNumber'))
        obj.phoneCardNumber = ApiClient.convertToType(data['phoneCardNumber'], 'String');
      ...
      if (data.hasOwnProperty('initialLoadProcessed'))
        obj.initialLoadProcessed = ApiClient.convertToType(data['initialLoadProcessed'], 'String');
      if (data.hasOwnProperty('loadAmount'))
        obj.loadAmount = ApiClient.convertToType(data['loadAmount'], 'Number');
      if (data.hasOwnProperty('balance'))
        obj.balance = InquiryBalanceV2ViewModel.constructFromObject(data['balance']);
