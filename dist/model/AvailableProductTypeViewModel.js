...
exports.AvailableProductTypeViewModel = void 0;
 ...
 * @version 2.0
 */
var AvailableProductTypeViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AvailableProductTypeViewModel</code>.
   * @alias module:model/AvailableProductTypeViewModel
   * @class
   */
  function AvailableProductTypeViewModel() {
    _classCallCheck(this, AvailableProductTypeViewModel);
  }
   ...
   */
  _createClass(AvailableProductTypeViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AvailableProductTypeViewModel();
        if (data.hasOwnProperty('productType')) obj.productType = _ApiClient.ApiClient.convertToType(data['productType'], 'Number');
        if (data.hasOwnProperty('displayName')) obj.displayName = _ApiClient.ApiClient.convertToType(data['displayName'], 'String');
        if (data.hasOwnProperty('mappedTo')) obj.mappedTo = _ApiClient.ApiClient.convertToType(data['mappedTo'], 'String');
        if (data.hasOwnProperty('kycType')) obj.kycType = _ApiClient.ApiClient.convertToType(data['kycType'], 'String');
        if (data.hasOwnProperty('kycId')) obj.kycId = _ApiClient.ApiClient.convertToType(data['kycId'], 'Number');
  ...
  return AvailableProductTypeViewModel;
}();
/**
 * @member {Number} productType
 */
exports.AvailableProductTypeViewModel = AvailableProductTypeViewModel;
