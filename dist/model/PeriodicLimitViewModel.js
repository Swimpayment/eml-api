...
exports.PeriodicLimitViewModel = void 0;
 ...
 * @version 2.0
 */
var PeriodicLimitViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PeriodicLimitViewModel</code>.
   * @alias module:model/PeriodicLimitViewModel
   * @class
   */
  function PeriodicLimitViewModel() {
    _classCallCheck(this, PeriodicLimitViewModel);
  }
   ...
   */
  _createClass(PeriodicLimitViewModel, null, [{
  ...
  return PeriodicLimitViewModel;
}();
/**
 * @member {Number} maxTransactionAmount
 */
exports.PeriodicLimitViewModel = PeriodicLimitViewModel;
