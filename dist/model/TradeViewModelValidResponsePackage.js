...
exports.TradeViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _TradeViewModel = require("./TradeViewModel");
 ...
 * @version 2.0
 */
var TradeViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function TradeViewModelValidResponsePackage() {
    _classCallCheck(this, TradeViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(TradeViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TradeViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _TradeViewModel.TradeViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return TradeViewModelValidResponsePackage;
}();
/**
 * @member {module:model/TradeViewModel} data
 */
exports.TradeViewModelValidResponsePackage = TradeViewModelValidResponsePackage;
