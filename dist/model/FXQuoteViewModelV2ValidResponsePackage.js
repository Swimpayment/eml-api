...
exports.FXQuoteViewModelV2ValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _FXQuoteViewModelV = require("./FXQuoteViewModelV2");
 ...
 * @version 2.0
 */
var FXQuoteViewModelV2ValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function FXQuoteViewModelV2ValidResponsePackage() {
    _classCallCheck(this, FXQuoteViewModelV2ValidResponsePackage);
  }
   ...
   */
  _createClass(FXQuoteViewModelV2ValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new FXQuoteViewModelV2ValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _FXQuoteViewModelV.FXQuoteViewModelV2.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return FXQuoteViewModelV2ValidResponsePackage;
}();
/**
 * @member {module:model/FXQuoteViewModelV2} data
 */
exports.FXQuoteViewModelV2ValidResponsePackage = FXQuoteViewModelV2ValidResponsePackage;
