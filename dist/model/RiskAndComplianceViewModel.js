...
exports.RiskAndComplianceViewModel = void 0;
 ...
 * @version 2.0
 */
var RiskAndComplianceViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RiskAndComplianceViewModel</code>.
   * @alias module:model/RiskAndComplianceViewModel
   * @class
   */
  function RiskAndComplianceViewModel() {
    _classCallCheck(this, RiskAndComplianceViewModel);
  }
   ...
   */
  _createClass(RiskAndComplianceViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RiskAndComplianceViewModel();
        if (data.hasOwnProperty('isMatchFound')) obj.isMatchFound = _ApiClient.ApiClient.convertToType(data['isMatchFound'], 'Boolean');
      }
      return obj;
    }
  }]);
  return RiskAndComplianceViewModel;
}();
/**
 * @member {Boolean} isMatchFound
 */
exports.RiskAndComplianceViewModel = RiskAndComplianceViewModel;
