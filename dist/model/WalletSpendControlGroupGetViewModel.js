...
exports.WalletSpendControlGroupGetViewModel = void 0;
var _ApiClient = require("../ApiClient");
var _WalletSpendControlGroupModel = require("./WalletSpendControlGroupModel");
 ...
 * @version 2.0
 */
var WalletSpendControlGroupGetViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WalletSpendControlGroupGetViewModel</code>.
   * @alias module:model/WalletSpendControlGroupGetViewModel
   * @class
   */
  function WalletSpendControlGroupGetViewModel() {
    _classCallCheck(this, WalletSpendControlGroupGetViewModel);
  }
   ...
   */
  _createClass(WalletSpendControlGroupGetViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new WalletSpendControlGroupGetViewModel();
        if (data.hasOwnProperty('walletSpendControls')) obj.walletSpendControls = _ApiClient.ApiClient.convertToType(data['walletSpendControls'], [_WalletSpendControlGroupModel.WalletSpendControlGroupModel]);
      }
      return obj;
    }
  }]);
  return WalletSpendControlGroupGetViewModel;
}();
/**
 * @member {Array.<module:model/WalletSpendControlGroupModel>} walletSpendControls
 */
exports.WalletSpendControlGroupGetViewModel = WalletSpendControlGroupGetViewModel;
