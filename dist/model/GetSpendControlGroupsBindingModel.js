...
exports.GetSpendControlGroupsBindingModel = void 0;
 ...
 * @version 2.0
 */
var GetSpendControlGroupsBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetSpendControlGroupsBindingModel(bin, distributorCode) {
    _classCallCheck(this, GetSpendControlGroupsBindingModel);
    this.bin = bin;
   ...
   */
  _createClass(GetSpendControlGroupsBindingModel, null, [{
  ...
  return GetSpendControlGroupsBindingModel;
}();
/**
 * Bin
 * @member {String} bin
 */
exports.GetSpendControlGroupsBindingModel = GetSpendControlGroupsBindingModel;
