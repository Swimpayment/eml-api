...
exports.AddRegistrationRuleViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _AddRegistrationRuleViewModel = require("./AddRegistrationRuleViewModel");
 ...
 * @version 2.0
 */
var AddRegistrationRuleViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function AddRegistrationRuleViewModelValidResponsePackage() {
    _classCallCheck(this, AddRegistrationRuleViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(AddRegistrationRuleViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AddRegistrationRuleViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _AddRegistrationRuleViewModel.AddRegistrationRuleViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return AddRegistrationRuleViewModelValidResponsePackage;
}();
/**
 * @member {module:model/AddRegistrationRuleViewModel} data
 */
exports.AddRegistrationRuleViewModelValidResponsePackage = AddRegistrationRuleViewModelValidResponsePackage;
