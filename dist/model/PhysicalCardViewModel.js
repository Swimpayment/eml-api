...
exports.PhysicalCardViewModel = void 0;
 ...
 * @version 2.0
 */
var PhysicalCardViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PhysicalCardViewModel</code>.
   * @alias module:model/PhysicalCardViewModel
   * @class
   */
  function PhysicalCardViewModel() {
    _classCallCheck(this, PhysicalCardViewModel);
  }
   ...
   */
  _createClass(PhysicalCardViewModel, null, [{
  ...
  return PhysicalCardViewModel;
}();
exports.PhysicalCardViewModel = PhysicalCardViewModel;