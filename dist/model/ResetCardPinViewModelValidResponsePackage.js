...
exports.ResetCardPinViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _ResetCardPinViewModel = require("./ResetCardPinViewModel");
 ...
 * @version 2.0
 */
var ResetCardPinViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function ResetCardPinViewModelValidResponsePackage() {
    _classCallCheck(this, ResetCardPinViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(ResetCardPinViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ResetCardPinViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _ResetCardPinViewModel.ResetCardPinViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return ResetCardPinViewModelValidResponsePackage;
}();
/**
 * @member {module:model/ResetCardPinViewModel} data
 */
exports.ResetCardPinViewModelValidResponsePackage = ResetCardPinViewModelValidResponsePackage;
