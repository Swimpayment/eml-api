...
exports.IbanStatusViewModel = void 0;
 ...
 * @version 2.0
 */
var IbanStatusViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IbanStatusViewModel</code>.
   * @alias module:model/IbanStatusViewModel
   * @class
   */
  function IbanStatusViewModel() {
    _classCallCheck(this, IbanStatusViewModel);
  }
   ...
   */
  _createClass(IbanStatusViewModel, null, [{
  ...
  return IbanStatusViewModel;
}();
/**
 * @member {String} status
 */
exports.IbanStatusViewModel = IbanStatusViewModel;
