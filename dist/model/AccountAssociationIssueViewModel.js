...
exports.AccountAssociationIssueViewModel = void 0;
 ...
 * @version 2.0
 */
var AccountAssociationIssueViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>AccountAssociationIssueViewModel</code>.
   * @alias module:model/AccountAssociationIssueViewModel
   * @class
   */
  function AccountAssociationIssueViewModel() {
    _classCallCheck(this, AccountAssociationIssueViewModel);
  }
   ...
   */
  _createClass(AccountAssociationIssueViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AccountAssociationIssueViewModel();
        if (data.hasOwnProperty('masterId')) obj.masterId = _ApiClient.ApiClient.convertToType(data['masterId'], 'Number');
        if (data.hasOwnProperty('virtualIds')) obj.virtualIds = _ApiClient.ApiClient.convertToType(data['virtualIds'], ['Number']);
      }
      return obj;
    }
  }]);
  return AccountAssociationIssueViewModel;
}();
/**
 * @member {Number} masterId
 */
exports.AccountAssociationIssueViewModel = AccountAssociationIssueViewModel;
