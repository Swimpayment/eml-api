...
exports.AdjustmentBindingModelV2 = void 0;
 ...
 * @version 2.0
 */
var AdjustmentBindingModelV2 = /*#__PURE__*/function () {
  /**
   ...
   */
  function AdjustmentBindingModelV2(amount, currencyCode, settlementCurrencyCode) {
    _classCallCheck(this, AdjustmentBindingModelV2);
    this.amount = amount;
   ...
   */
  _createClass(AdjustmentBindingModelV2, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('affectedBalance')) obj.affectedBalance = _ApiClient.ApiClient.convertToType(data['affectedBalance'], 'String');
      }
      return obj;
    }
  }]);
  return AdjustmentBindingModelV2;
}();
/**
 * Adjustment Amount (in subunit, i.e.: Penny).
 * @member {Number} amount
 */
exports.AdjustmentBindingModelV2 = AdjustmentBindingModelV2;
