 ...
 * @version 2.0
 */
var JwtToken = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>JwtToken</code>.
   * Response model of JWT token.
  ...
  _createClass(JwtToken, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('accessToken')) obj.accessToken = _ApiClient.ApiClient.convertToType(data['accessToken'], 'String');
        if (data.hasOwnProperty('expiresIn')) obj.expiresIn = _ApiClient.ApiClient.convertToType(data['expiresIn'], 'Number');
      }
      return obj;
    }
  }]);
...
JwtToken.prototype.accessToken = undefined;

/**
 * JWT token expire date.
 * @member {Number} expiresIn
 */
JwtToken.prototype.expiresIn = undefined;