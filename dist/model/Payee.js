  ...
  _createClass(Payee, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('bankSortCode')) obj.bankSortCode = _ApiClient.ApiClient.convertToType(data['bankSortCode'], 'String');
        if (data.hasOwnProperty('beneficiaryName')) obj.beneficiaryName = _ApiClient.ApiClient.convertToType(data['beneficiaryName'], 'String');
        if (data.hasOwnProperty('iban')) obj.iban = _ApiClient.ApiClient.convertToType(data['iban'], 'String');
        if (data.hasOwnProperty('swiftBicCode')) obj.swiftBicCode = _ApiClient.ApiClient.convertToType(data['swiftBicCode'], 'String');
      }
      return obj;
    }
  }]);
