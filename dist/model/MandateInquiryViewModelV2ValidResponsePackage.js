...
exports.MandateInquiryViewModelV2ValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _MandateInquiryViewModelV = require("./MandateInquiryViewModelV2");
 ...
 * @version 2.0
 */
var MandateInquiryViewModelV2ValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function MandateInquiryViewModelV2ValidResponsePackage() {
    _classCallCheck(this, MandateInquiryViewModelV2ValidResponsePackage);
  }
   ...
   */
  _createClass(MandateInquiryViewModelV2ValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new MandateInquiryViewModelV2ValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _MandateInquiryViewModelV.MandateInquiryViewModelV2.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return MandateInquiryViewModelV2ValidResponsePackage;
}();
/**
 * @member {module:model/MandateInquiryViewModelV2} data
 */
exports.MandateInquiryViewModelV2ValidResponsePackage = MandateInquiryViewModelV2ValidResponsePackage;
