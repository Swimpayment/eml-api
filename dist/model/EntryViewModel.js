 ...
 * @version 2.0
 */
var EntryViewModel = /*#__PURE__*/function () {
  /**
   ...
   */
  _createClass(EntryViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new EntryViewModel();
        if (data.hasOwnProperty('matchType')) obj.matchType = _ApiClient.ApiClient.convertToType(data['matchType'], 'String');
 ...
 */
exports.EntryViewModel = EntryViewModel;
