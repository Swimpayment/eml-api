...
exports.CorporateBalancesViewModelV2ValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _CorporateBalancesViewModelV = require("./CorporateBalancesViewModelV2");
 ...
 * @version 2.0
 */
var CorporateBalancesViewModelV2ValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function CorporateBalancesViewModelV2ValidResponsePackage() {
    _classCallCheck(this, CorporateBalancesViewModelV2ValidResponsePackage);
  }
   ...
   */
  _createClass(CorporateBalancesViewModelV2ValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CorporateBalancesViewModelV2ValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _CorporateBalancesViewModelV.CorporateBalancesViewModelV2.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return CorporateBalancesViewModelV2ValidResponsePackage;
}();
/**
 * @member {module:model/CorporateBalancesViewModelV2} data
 */
exports.CorporateBalancesViewModelV2ValidResponsePackage = CorporateBalancesViewModelV2ValidResponsePackage;
