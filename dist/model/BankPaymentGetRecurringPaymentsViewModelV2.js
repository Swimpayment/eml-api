...
exports.BankPaymentGetRecurringPaymentsViewModelV2 = void 0;
var _ApiClient = require("../ApiClient");
var _RecurringPaymentResponseItemViewModelV = require("./RecurringPaymentResponseItemViewModelV2");
 ...
 * @version 2.0
 */
var BankPaymentGetRecurringPaymentsViewModelV2 = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function BankPaymentGetRecurringPaymentsViewModelV2() {
    _classCallCheck(this, BankPaymentGetRecurringPaymentsViewModelV2);
  }
   ...
   */
  _createClass(BankPaymentGetRecurringPaymentsViewModelV2, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BankPaymentGetRecurringPaymentsViewModelV2();
        if (data.hasOwnProperty('settings')) obj.settings = _ApiClient.ApiClient.convertToType(data['settings'], [_RecurringPaymentResponseItemViewModelV.RecurringPaymentResponseItemViewModelV2]);
      }
      return obj;
    }
  }]);
  return BankPaymentGetRecurringPaymentsViewModelV2;
}();
/**
 * Recurring payment settings of cardholder
 * @member {Array.<module:model/RecurringPaymentResponseItemViewModelV2>} settings
 */
exports.BankPaymentGetRecurringPaymentsViewModelV2 = BankPaymentGetRecurringPaymentsViewModelV2;
