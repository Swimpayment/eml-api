...
exports.GetMT103ViewModel = void 0;
 ...
 * @version 2.0
 */
var GetMT103ViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetMT103ViewModel</code>.
   * @alias module:model/GetMT103ViewModel
   * @class
   */
  function GetMT103ViewModel() {
    _classCallCheck(this, GetMT103ViewModel);
  }
   ...
   */
  _createClass(GetMT103ViewModel, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mT103')) obj.mT103 = _ApiClient.ApiClient.convertToType(data['mT103'], 'String');
        if (data.hasOwnProperty('submission_Ref')) obj.submissionRef = _ApiClient.ApiClient.convertToType(data['submission_Ref'], 'String');
      }
      return obj;
    }
  }]);
  return GetMT103ViewModel;
}();
/**
 * @member {String} status
 */
exports.GetMT103ViewModel = GetMT103ViewModel;
