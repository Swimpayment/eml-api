...
exports.WalletSpendControlGroupModel = void 0;
 ...
 * @version 2.0
 */
var WalletSpendControlGroupModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>WalletSpendControlGroupModel</code>.
   * @alias module:model/WalletSpendControlGroupModel
   * @class
   */
  function WalletSpendControlGroupModel() {
    _classCallCheck(this, WalletSpendControlGroupModel);
  }
   ...
   */
  _createClass(WalletSpendControlGroupModel, null, [{
  ...
  return WalletSpendControlGroupModel;
}();
/**
 * @member {String} bin
 */
exports.WalletSpendControlGroupModel = WalletSpendControlGroupModel;
