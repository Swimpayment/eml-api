...
exports.MultiplePurse = void 0;
var _ApiClient = require("../ApiClient");
var _Purse = require("./Purse");
 ...
 * @version 2.0
 */
var MultiplePurse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MultiplePurse</code>.
   * @alias module:model/MultiplePurse
   * @class
   */
  function MultiplePurse() {
    _classCallCheck(this, MultiplePurse);
  }
   ...
   */
  _createClass(MultiplePurse, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new MultiplePurse();
        if (data.hasOwnProperty('purse')) obj.purse = _ApiClient.ApiClient.convertToType(data['purse'], [_Purse.Purse]);
      }
      return obj;
    }
  }]);
  return MultiplePurse;
}();
/**
 * @member {Array.<module:model/Purse>} purse
 */
exports.MultiplePurse = MultiplePurse;
