...
exports.GetDirectDebitCancellationsViewModelV2ValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _GetDirectDebitCancellationsViewModelV = require("./GetDirectDebitCancellationsViewModelV2");
 ...
 * @version 2.0
 */
var GetDirectDebitCancellationsViewModelV2ValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function GetDirectDebitCancellationsViewModelV2ValidResponsePackage() {
    _classCallCheck(this, GetDirectDebitCancellationsViewModelV2ValidResponsePackage);
  }
   ...
   */
  _createClass(GetDirectDebitCancellationsViewModelV2ValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetDirectDebitCancellationsViewModelV2ValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _GetDirectDebitCancellationsViewModelV.GetDirectDebitCancellationsViewModelV2.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return GetDirectDebitCancellationsViewModelV2ValidResponsePackage;
}();
/**
 * @member {module:model/GetDirectDebitCancellationsViewModelV2} data
 */
exports.GetDirectDebitCancellationsViewModelV2ValidResponsePackage = GetDirectDebitCancellationsViewModelV2ValidResponsePackage;
