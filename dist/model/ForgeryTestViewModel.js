...
exports.ForgeryTestViewModel = void 0;
 ...
 * @version 2.0
 */
var ForgeryTestViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ForgeryTestViewModel</code>.
   * @alias module:model/ForgeryTestViewModel
   * @class
   */
  function ForgeryTestViewModel() {
    _classCallCheck(this, ForgeryTestViewModel);
  }
   ...
   */
  _createClass(ForgeryTestViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ForgeryTestViewModel();
        if (data.hasOwnProperty('testAuthenticity')) obj.testAuthenticity = _ApiClient.ApiClient.convertToType(data['testAuthenticity'], 'Number');
        if (data.hasOwnProperty('testName')) obj.testName = _ApiClient.ApiClient.convertToType(data['testName'], 'String');
      }
      return obj;
    }
  }]);
  return ForgeryTestViewModel;
}();
/**
 * @member {Number} testAuthenticity
 */
exports.ForgeryTestViewModel = ForgeryTestViewModel;
