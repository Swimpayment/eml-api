...
exports.SepaTransactionCountBindingModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _SepaTransactionCountBindingModel = require("./SepaTransactionCountBindingModel");
 ...
 * @version 2.0
 */
var SepaTransactionCountBindingModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function SepaTransactionCountBindingModelValidResponsePackage() {
    _classCallCheck(this, SepaTransactionCountBindingModelValidResponsePackage);
  }
   ...
   */
  _createClass(SepaTransactionCountBindingModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new SepaTransactionCountBindingModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _SepaTransactionCountBindingModel.SepaTransactionCountBindingModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return SepaTransactionCountBindingModelValidResponsePackage;
}();
/**
 * @member {module:model/SepaTransactionCountBindingModel} data
 */
exports.SepaTransactionCountBindingModelValidResponsePackage = SepaTransactionCountBindingModelValidResponsePackage;
