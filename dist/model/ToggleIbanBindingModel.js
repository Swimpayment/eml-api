...
exports.ToggleIbanBindingModel = void 0;
 ...
 * @version 2.0
 */
var ToggleIbanBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function ToggleIbanBindingModel(toggleIban) {
    _classCallCheck(this, ToggleIbanBindingModel);
   ...
   */
  _createClass(ToggleIbanBindingModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ToggleIbanBindingModel();
        if (data.hasOwnProperty('toggleIban')) obj.toggleIban = _ApiClient.ApiClient.convertToType(data['toggleIban'], 'Boolean');
      }
      return obj;
    }
  }]);
  return ToggleIbanBindingModel;
}();
/**
 * True, enables bank payments. False, disables bank payments
 * @member {Boolean} toggleIban
 */
exports.ToggleIbanBindingModel = ToggleIbanBindingModel;
