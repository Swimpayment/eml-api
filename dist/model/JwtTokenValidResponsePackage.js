...
exports.JwtTokenValidResponsePackage = void 0;
 ...
 * @version 2.0
 */
var JwtTokenValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function JwtTokenValidResponsePackage() {
    _classCallCheck(this, JwtTokenValidResponsePackage);
  }
   ...
   */
  _createClass(JwtTokenValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new JwtTokenValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _JwtToken.JwtToken.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return JwtTokenValidResponsePackage;
}();
/**
 * @member {module:model/JwtToken} data
 */
exports.JwtTokenValidResponsePackage = JwtTokenValidResponsePackage;
