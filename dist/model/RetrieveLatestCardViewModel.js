...
exports.RetrieveLatestCardViewModel = void 0;
 ...
 * @version 2.0
 */
var RetrieveLatestCardViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>RetrieveLatestCardViewModel</code>.
   * @alias module:model/RetrieveLatestCardViewModel
   * @class
   */
  function RetrieveLatestCardViewModel() {
    _classCallCheck(this, RetrieveLatestCardViewModel);
  }
   ...
   */
  _createClass(RetrieveLatestCardViewModel, null, [{
  ...
  return RetrieveLatestCardViewModel;
}();
/**
 * Latest cardnumber.
 * @member {String} cardNumber
 */
exports.RetrieveLatestCardViewModel = RetrieveLatestCardViewModel;
