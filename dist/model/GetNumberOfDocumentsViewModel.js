...
exports.GetNumberOfDocumentsViewModel = void 0;
 ...
 * @version 2.0
 */
var GetNumberOfDocumentsViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetNumberOfDocumentsViewModel</code>.
   * @alias module:model/GetNumberOfDocumentsViewModel
   * @class
   */
  function GetNumberOfDocumentsViewModel() {
    _classCallCheck(this, GetNumberOfDocumentsViewModel);
  }
   ...
   */
  _createClass(GetNumberOfDocumentsViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetNumberOfDocumentsViewModel();
        if (data.hasOwnProperty('idCountValid')) obj.idCountValid = _ApiClient.ApiClient.convertToType(data['idCountValid'], 'Boolean');
        if (data.hasOwnProperty('uploadedIdsCount')) obj.uploadedIdsCount = _ApiClient.ApiClient.convertToType(data['uploadedIdsCount'], 'Number');
        if (data.hasOwnProperty('maximumDocuments')) obj.maximumDocuments = _ApiClient.ApiClient.convertToType(data['maximumDocuments'], 'Number');
      }
      return obj;
    }
  }]);
  return GetNumberOfDocumentsViewModel;
}();
/**
 * @member {Boolean} idCountValid
 */
exports.GetNumberOfDocumentsViewModel = GetNumberOfDocumentsViewModel;
