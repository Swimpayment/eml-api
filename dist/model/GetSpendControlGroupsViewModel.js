...
exports.GetSpendControlGroupsViewModel = void 0;
var _ApiClient = require("../ApiClient");
var _EcmSpendControlGroup = require("./EcmSpendControlGroup");
 ...
 * @version 2.0
 */
var GetSpendControlGroupsViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetSpendControlGroupsViewModel</code>.
   * @alias module:model/GetSpendControlGroupsViewModel
   * @class
   */
  function GetSpendControlGroupsViewModel() {
    _classCallCheck(this, GetSpendControlGroupsViewModel);
  }
   ...
   */
  _createClass(GetSpendControlGroupsViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetSpendControlGroupsViewModel();
        if (data.hasOwnProperty('spendControlGroups')) obj.spendControlGroups = _ApiClient.ApiClient.convertToType(data['spendControlGroups'], [_EcmSpendControlGroup.EcmSpendControlGroup]);
      }
      return obj;
    }
  }]);
  return GetSpendControlGroupsViewModel;
}();
/**
 * @member {Array.<module:model/EcmSpendControlGroup>} spendControlGroups
 */
exports.GetSpendControlGroupsViewModel = GetSpendControlGroupsViewModel;
