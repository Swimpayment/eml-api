...
exports.GetExpiryDateViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _GetExpiryDateViewModel = require("./GetExpiryDateViewModel");
 ...
 * @version 2.0
 */
var GetExpiryDateViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function GetExpiryDateViewModelValidResponsePackage() {
    _classCallCheck(this, GetExpiryDateViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(GetExpiryDateViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetExpiryDateViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _GetExpiryDateViewModel.GetExpiryDateViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return GetExpiryDateViewModelValidResponsePackage;
}();
/**
 * @member {module:model/GetExpiryDateViewModel} data
 */
exports.GetExpiryDateViewModelValidResponsePackage = GetExpiryDateViewModelValidResponsePackage;
