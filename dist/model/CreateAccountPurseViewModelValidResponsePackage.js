...
exports.CreateAccountPurseViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _CreateAccountPurseViewModel = require("./CreateAccountPurseViewModel");
 ...
 * @version 2.0
 */
var CreateAccountPurseViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function CreateAccountPurseViewModelValidResponsePackage() {
    _classCallCheck(this, CreateAccountPurseViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(CreateAccountPurseViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CreateAccountPurseViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _CreateAccountPurseViewModel.CreateAccountPurseViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return CreateAccountPurseViewModelValidResponsePackage;
}();
/**
 * @member {module:model/CreateAccountPurseViewModel} data
 */
exports.CreateAccountPurseViewModelValidResponsePackage = CreateAccountPurseViewModelValidResponsePackage;
