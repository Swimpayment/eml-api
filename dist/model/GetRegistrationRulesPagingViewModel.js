...
exports.GetRegistrationRulesPagingViewModel = void 0;
 ...
 * @version 2.0
 */
var GetRegistrationRulesPagingViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetRegistrationRulesPagingViewModel</code>.
   * @alias module:model/GetRegistrationRulesPagingViewModel
   * @class
   */
  function GetRegistrationRulesPagingViewModel() {
    _classCallCheck(this, GetRegistrationRulesPagingViewModel);
  }
   ...
   */
  _createClass(GetRegistrationRulesPagingViewModel, null, [{
  ...
  return GetRegistrationRulesPagingViewModel;
}();
/**
 * @member {Number} pageNo
 */
exports.GetRegistrationRulesPagingViewModel = GetRegistrationRulesPagingViewModel;
