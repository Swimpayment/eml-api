...
exports.NominatedPersonGetViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _NominatedPersonGetViewModel = require("./NominatedPersonGetViewModel");
 ...
 * @version 2.0
 */
var NominatedPersonGetViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function NominatedPersonGetViewModelValidResponsePackage() {
    _classCallCheck(this, NominatedPersonGetViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(NominatedPersonGetViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new NominatedPersonGetViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _NominatedPersonGetViewModel.NominatedPersonGetViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return NominatedPersonGetViewModelValidResponsePackage;
}();
/**
 * @member {module:model/NominatedPersonGetViewModel} data
 */
exports.NominatedPersonGetViewModelValidResponsePackage = NominatedPersonGetViewModelValidResponsePackage;
