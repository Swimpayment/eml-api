...
exports.CheckAttemptedRegistrationViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _CheckAttemptedRegistrationViewModel = require("./CheckAttemptedRegistrationViewModel");
 ...
 * @version 2.0
 */
var CheckAttemptedRegistrationViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function CheckAttemptedRegistrationViewModelValidResponsePackage() {
    _classCallCheck(this, CheckAttemptedRegistrationViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(CheckAttemptedRegistrationViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new CheckAttemptedRegistrationViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _CheckAttemptedRegistrationViewModel.CheckAttemptedRegistrationViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return CheckAttemptedRegistrationViewModelValidResponsePackage;
}();
/**
 * @member {module:model/CheckAttemptedRegistrationViewModel} data
 */
exports.CheckAttemptedRegistrationViewModelValidResponsePackage = CheckAttemptedRegistrationViewModelValidResponsePackage;
