...
exports.AccountIdV2ViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _AccountIdV2ViewModel = require("./AccountIdV2ViewModel");
 ...
 * @version 2.0
 */
var AccountIdV2ViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function AccountIdV2ViewModelValidResponsePackage() {
    _classCallCheck(this, AccountIdV2ViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(AccountIdV2ViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AccountIdV2ViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _AccountIdV2ViewModel.AccountIdV2ViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return AccountIdV2ViewModelValidResponsePackage;
}();
/**
 * @member {module:model/AccountIdV2ViewModel} data
 */
exports.AccountIdV2ViewModelValidResponsePackage = AccountIdV2ViewModelValidResponsePackage;
