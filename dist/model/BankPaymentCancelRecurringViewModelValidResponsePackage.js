...
exports.BankPaymentCancelRecurringViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _BankPaymentCancelRecurringViewModel = require("./BankPaymentCancelRecurringViewModel");
 ...
 * @version 2.0
 */
var BankPaymentCancelRecurringViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function BankPaymentCancelRecurringViewModelValidResponsePackage() {
    _classCallCheck(this, BankPaymentCancelRecurringViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(BankPaymentCancelRecurringViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BankPaymentCancelRecurringViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _BankPaymentCancelRecurringViewModel.BankPaymentCancelRecurringViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return BankPaymentCancelRecurringViewModelValidResponsePackage;
}();
/**
 * @member {module:model/BankPaymentCancelRecurringViewModel} data
 */
exports.BankPaymentCancelRecurringViewModelValidResponsePackage = BankPaymentCancelRecurringViewModelValidResponsePackage;
