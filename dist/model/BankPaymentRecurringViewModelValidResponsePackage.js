...
exports.BankPaymentRecurringViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _BankPaymentRecurringViewModel = require("./BankPaymentRecurringViewModel");
 ...
 * @version 2.0
 */
var BankPaymentRecurringViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function BankPaymentRecurringViewModelValidResponsePackage() {
    _classCallCheck(this, BankPaymentRecurringViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(BankPaymentRecurringViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BankPaymentRecurringViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _BankPaymentRecurringViewModel.BankPaymentRecurringViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return BankPaymentRecurringViewModelValidResponsePackage;
}();
/**
 * @member {module:model/BankPaymentRecurringViewModel} data
 */
exports.BankPaymentRecurringViewModelValidResponsePackage = BankPaymentRecurringViewModelValidResponsePackage;
