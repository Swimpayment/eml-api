...
exports.ConditionCheckViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _ConditionCheckViewModel = require("./ConditionCheckViewModel");
 ...
 * @version 2.0
 */
var ConditionCheckViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function ConditionCheckViewModelValidResponsePackage() {
    _classCallCheck(this, ConditionCheckViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(ConditionCheckViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ConditionCheckViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _ConditionCheckViewModel.ConditionCheckViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return ConditionCheckViewModelValidResponsePackage;
}();
/**
 * @member {module:model/ConditionCheckViewModel} data
 */
exports.ConditionCheckViewModelValidResponsePackage = ConditionCheckViewModelValidResponsePackage;
