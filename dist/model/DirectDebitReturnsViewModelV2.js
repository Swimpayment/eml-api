...
exports.DirectDebitReturnsViewModelV2 = void 0;
var _ApiClient = require("../ApiClient");
var _DirectDebitReturnTransactionViewModelV = require("./DirectDebitReturnTransactionViewModelV2");
 ...
 * @version 2.0
 */
var DirectDebitReturnsViewModelV2 = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DirectDebitReturnsViewModelV2</code>.
   * @alias module:model/DirectDebitReturnsViewModelV2
   * @class
   */
  function DirectDebitReturnsViewModelV2() {
    _classCallCheck(this, DirectDebitReturnsViewModelV2);
  }
   ...
   */
  _createClass(DirectDebitReturnsViewModelV2, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('recievedDateTime')) obj.recievedDateTime = _ApiClient.ApiClient.convertToType(data['recievedDateTime'], 'String');
        if (data.hasOwnProperty('transactions')) obj.transactions = _ApiClient.ApiClient.convertToType(data['transactions'], [_DirectDebitReturnTransactionViewModelV.DirectDebitReturnTransactionViewModelV2]);
      }
      return obj;
    }
  }]);
  return DirectDebitReturnsViewModelV2;
}();
/**
 * @member {String} messageId
 */
exports.DirectDebitReturnsViewModelV2 = DirectDebitReturnsViewModelV2;
