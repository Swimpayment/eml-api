 ...
 * @version 2.0
 */
var MDESAuditInfo = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MDESAuditInfo</code>.
   * @alias module:model/MDESAuditInfo
   * @class
   */
  function MDESAuditInfo() {
    _classCallCheck(this, MDESAuditInfo);
  }
   ...
   */
  _createClass(MDESAuditInfo, null, [{
  ...
  return MDESAuditInfo;
}();
/**
 * @member {String} userId
 */
exports.MDESAuditInfo = MDESAuditInfo;
