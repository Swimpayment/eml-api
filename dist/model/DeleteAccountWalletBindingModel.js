...
exports.DeleteAccountWalletBindingModel = void 0;
 ...
 * @version 2.0
 */
var DeleteAccountWalletBindingModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>DeleteAccountWalletBindingModel</code>.
   * @alias module:model/DeleteAccountWalletBindingModel
   * @class
   */
  function DeleteAccountWalletBindingModel() {
    _classCallCheck(this, DeleteAccountWalletBindingModel);
  }
   ...
   */
  _createClass(DeleteAccountWalletBindingModel, null, [{
  ...
  return DeleteAccountWalletBindingModel;
}();
/**
 * Name of the wallet to delete
 * @member {String} walletName
 */
exports.DeleteAccountWalletBindingModel = DeleteAccountWalletBindingModel;
