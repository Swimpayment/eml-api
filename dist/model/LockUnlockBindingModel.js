...
exports.LockUnlockBindingModel = void 0;
 ...
 * @version 2.0
 */
var LockUnlockBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function LockUnlockBindingModel(status) {
    _classCallCheck(this, LockUnlockBindingModel);
    this.status = status;
  }
   ...
   */
  _createClass(LockUnlockBindingModel, null, [{
  ...
  return LockUnlockBindingModel;
}();
/**
 * Status code you want to apply to the card. Open = 1, Deposit Only = 4
 * @member {String} status
 */
exports.LockUnlockBindingModel = LockUnlockBindingModel;
