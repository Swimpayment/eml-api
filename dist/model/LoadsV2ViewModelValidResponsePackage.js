...
exports.LoadsV2ViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _LoadsV2ViewModel = require("./LoadsV2ViewModel");
 ...
 * @version 2.0
 */
var LoadsV2ViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function LoadsV2ViewModelValidResponsePackage() {
    _classCallCheck(this, LoadsV2ViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(LoadsV2ViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new LoadsV2ViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _LoadsV2ViewModel.LoadsV2ViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return LoadsV2ViewModelValidResponsePackage;
}();
/**
 * @member {module:model/LoadsV2ViewModel} data
 */
exports.LoadsV2ViewModelValidResponsePackage = LoadsV2ViewModelValidResponsePackage;
