...
exports.KycRedeemCodeViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _KycRedeemCodeViewModel = require("./KycRedeemCodeViewModel");
 ...
 * @version 2.0
 */
var KycRedeemCodeViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function KycRedeemCodeViewModelValidResponsePackage() {
    _classCallCheck(this, KycRedeemCodeViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(KycRedeemCodeViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new KycRedeemCodeViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _KycRedeemCodeViewModel.KycRedeemCodeViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return KycRedeemCodeViewModelValidResponsePackage;
}();
/**
 * @member {module:model/KycRedeemCodeViewModel} data
 */
exports.KycRedeemCodeViewModelValidResponsePackage = KycRedeemCodeViewModelValidResponsePackage;
