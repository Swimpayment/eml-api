...
exports.IsAutoRenewableViewModel = void 0;
 ...
 * @version 2.0
 */
var IsAutoRenewableViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>IsAutoRenewableViewModel</code>.
   * @alias module:model/IsAutoRenewableViewModel
   * @class
   */
  function IsAutoRenewableViewModel() {
    _classCallCheck(this, IsAutoRenewableViewModel);
  }
   ...
   */
  _createClass(IsAutoRenewableViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new IsAutoRenewableViewModel();
        if (data.hasOwnProperty('isAutoRenewable')) obj.isAutoRenewable = _ApiClient.ApiClient.convertToType(data['isAutoRenewable'], 'Boolean');
      }
      return obj;
    }
  }]);
  return IsAutoRenewableViewModel;
}();
/**
 ...
 */
exports.IsAutoRenewableViewModel = IsAutoRenewableViewModel;
