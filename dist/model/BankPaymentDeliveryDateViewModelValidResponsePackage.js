...
exports.BankPaymentDeliveryDateViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _BankPaymentDeliveryDateViewModel = require("./BankPaymentDeliveryDateViewModel");
 ...
 * @version 2.0
 */
var BankPaymentDeliveryDateViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function BankPaymentDeliveryDateViewModelValidResponsePackage() {
    _classCallCheck(this, BankPaymentDeliveryDateViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(BankPaymentDeliveryDateViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new BankPaymentDeliveryDateViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _BankPaymentDeliveryDateViewModel.BankPaymentDeliveryDateViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return BankPaymentDeliveryDateViewModelValidResponsePackage;
}();
/**
 * @member {module:model/BankPaymentDeliveryDateViewModel} data
 */
exports.BankPaymentDeliveryDateViewModelValidResponsePackage = BankPaymentDeliveryDateViewModelValidResponsePackage;
