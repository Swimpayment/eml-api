...
exports.RiskAndComplianceViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _RiskAndComplianceViewModel = require("./RiskAndComplianceViewModel");
 ...
 * @version 2.0
 */
var RiskAndComplianceViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function RiskAndComplianceViewModelValidResponsePackage() {
    _classCallCheck(this, RiskAndComplianceViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(RiskAndComplianceViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new RiskAndComplianceViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _RiskAndComplianceViewModel.RiskAndComplianceViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return RiskAndComplianceViewModelValidResponsePackage;
}();
/**
 * @member {module:model/RiskAndComplianceViewModel} data
 */
exports.RiskAndComplianceViewModelValidResponsePackage = RiskAndComplianceViewModelValidResponsePackage;
