...
exports.ConditionCheckViewModel = void 0;
 ...
 * @version 2.0
 */
var ConditionCheckViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>ConditionCheckViewModel</code>.
   * @alias module:model/ConditionCheckViewModel
   * @class
   */
  function ConditionCheckViewModel() {
    _classCallCheck(this, ConditionCheckViewModel);
  }
   ...
   */
  _createClass(ConditionCheckViewModel, null, [{
  ...
  return ConditionCheckViewModel;
}();
exports.ConditionCheckViewModel = ConditionCheckViewModel;