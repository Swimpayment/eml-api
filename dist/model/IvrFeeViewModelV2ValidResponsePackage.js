...
exports.IvrFeeViewModelV2ValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _IvrFeeViewModelV = require("./IvrFeeViewModelV2");
 ...
 * @version 2.0
 */
var IvrFeeViewModelV2ValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function IvrFeeViewModelV2ValidResponsePackage() {
    _classCallCheck(this, IvrFeeViewModelV2ValidResponsePackage);
  }
   ...
   */
  _createClass(IvrFeeViewModelV2ValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new IvrFeeViewModelV2ValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _IvrFeeViewModelV.IvrFeeViewModelV2.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return IvrFeeViewModelV2ValidResponsePackage;
}();
/**
 * @member {module:model/IvrFeeViewModelV2} data
 */
exports.IvrFeeViewModelV2ValidResponsePackage = IvrFeeViewModelV2ValidResponsePackage;
