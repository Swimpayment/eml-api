...
exports.AccountPursesViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _AccountPursesViewModel = require("./AccountPursesViewModel");
 ...
 * @version 2.0
 */
var AccountPursesViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function AccountPursesViewModelValidResponsePackage() {
    _classCallCheck(this, AccountPursesViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(AccountPursesViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new AccountPursesViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _AccountPursesViewModel.AccountPursesViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return AccountPursesViewModelValidResponsePackage;
}();
/**
 * @member {module:model/AccountPursesViewModel} data
 */
exports.AccountPursesViewModelValidResponsePackage = AccountPursesViewModelValidResponsePackage;
