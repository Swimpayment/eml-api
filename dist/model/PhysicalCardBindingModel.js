...
exports.PhysicalCardBindingModel = void 0;
 ...
 * @version 2.0
 */
var PhysicalCardBindingModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>PhysicalCardBindingModel</code>.
   * @alias module:model/PhysicalCardBindingModel
   * @class
   */
  function PhysicalCardBindingModel() {
    _classCallCheck(this, PhysicalCardBindingModel);
  }
   ...
   */
  _createClass(PhysicalCardBindingModel, null, [{
  ...
  return PhysicalCardBindingModel;
}();
/**
 * Card style.
 * @member {String} cardStyle
 */
exports.PhysicalCardBindingModel = PhysicalCardBindingModel;
