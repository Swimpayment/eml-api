...
exports.ReplaceBindingModel = void 0;
 ...
 * @version 2.0
 */
var ReplaceBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function ReplaceBindingModel(replaceReason) {
    _classCallCheck(this, ReplaceBindingModel);
   ...
   */
  _createClass(ReplaceBindingModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new ReplaceBindingModel();
        if (data.hasOwnProperty('replaceReason')) obj.replaceReason = _ApiClient.ApiClient.convertToType(data['replaceReason'], 'String');
        ...
        if (data.hasOwnProperty('newPin')) obj.newPin = _ApiClient.ApiClient.convertToType(data['newPin'], 'String');
      }
      return obj;
    }
  }]);
  return ReplaceBindingModel;
}();
/**
 * Reason for issuing a replacement card
 * @member {String} replaceReason
 */
exports.ReplaceBindingModel = ReplaceBindingModel;
