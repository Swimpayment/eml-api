  ...
  _createClass(Device, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('deviceType')) obj.deviceType = _ApiClient.ApiClient.convertToType(data['deviceType'], 'String');
        if (data.hasOwnProperty('secureElementId')) obj.secureElementId = _ApiClient.ApiClient.convertToType(data['secureElementId'], 'String');
      }
      return obj;
    }
  }]);
