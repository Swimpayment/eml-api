...
exports.GetPayeeBindingModel = void 0;
 ...
 * @version 2.0
 */
var GetPayeeBindingModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetPayeeBindingModel</code>.
   * @alias module:model/GetPayeeBindingModel
   * @class
   */
  function GetPayeeBindingModel() {
    _classCallCheck(this, GetPayeeBindingModel);
  }
   ...
   */
  _createClass(GetPayeeBindingModel, null, [{
  ...
  return GetPayeeBindingModel;
}();
/**
 * @member {String} payeeId
 */
exports.GetPayeeBindingModel = GetPayeeBindingModel;
