...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardholderToCardholderViewModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.CardholderToCardholderViewModelV2();
      });

      it('should create an instance of CardholderToCardholderViewModelV2', function() {
        // TODO: update the code to test CardholderToCardholderViewModelV2
        expect(instance).to.be.a(FinacApi.CardholderToCardholderViewModelV2);
      });
