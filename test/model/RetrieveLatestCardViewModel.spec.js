...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveLatestCardViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.RetrieveLatestCardViewModel();
      });

      it('should create an instance of RetrieveLatestCardViewModel', function() {
        // TODO: update the code to test RetrieveLatestCardViewModel
        expect(instance).to.be.a(FinacApi.RetrieveLatestCardViewModel);
      });
