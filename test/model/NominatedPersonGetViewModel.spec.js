...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('NominatedPersonGetViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.NominatedPersonGetViewModel();
      });

      it('should create an instance of NominatedPersonGetViewModel', function() {
        // TODO: update the code to test NominatedPersonGetViewModel
        expect(instance).to.be.a(FinacApi.NominatedPersonGetViewModel);
      });
