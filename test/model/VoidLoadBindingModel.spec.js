...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VoidLoadBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.VoidLoadBindingModel();
      });

      it('should create an instance of VoidLoadBindingModel', function() {
        // TODO: update the code to test VoidLoadBindingModel
        expect(instance).to.be.a(FinacApi.VoidLoadBindingModel);
      });
