...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CorporateTransactionsBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.CorporateTransactionsBindingModel();
      });

      it('should create an instance of CorporateTransactionsBindingModel', function() {
        // TODO: update the code to test CorporateTransactionsBindingModel
        expect(instance).to.be.a(FinacApi.CorporateTransactionsBindingModel);
      });
