...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RecurringPaymentResponseItemViewModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.RecurringPaymentResponseItemViewModelV2();
      });

      it('should create an instance of RecurringPaymentResponseItemViewModelV2', function() {
        // TODO: update the code to test RecurringPaymentResponseItemViewModelV2
        expect(instance).to.be.a(FinacApi.RecurringPaymentResponseItemViewModelV2);
      });
