...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountInfoV2ViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.AccountInfoV2ViewModel();
      });

      it('should create an instance of AccountInfoV2ViewModel', function() {
        // TODO: update the code to test AccountInfoV2ViewModel
        expect(instance).to.be.a(FinacApi.AccountInfoV2ViewModel);
      });
