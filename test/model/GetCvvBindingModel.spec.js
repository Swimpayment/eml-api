...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCvvBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetCvvBindingModel();
      });

      it('should create an instance of GetCvvBindingModel', function() {
        // TODO: update the code to test GetCvvBindingModel
        expect(instance).to.be.a(FinacApi.GetCvvBindingModel);
      });
