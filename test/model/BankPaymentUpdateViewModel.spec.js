...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankPaymentUpdateViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.BankPaymentUpdateViewModel();
      });

      it('should create an instance of BankPaymentUpdateViewModel', function() {
        // TODO: update the code to test BankPaymentUpdateViewModel
        expect(instance).to.be.a(FinacApi.BankPaymentUpdateViewModel);
      });
