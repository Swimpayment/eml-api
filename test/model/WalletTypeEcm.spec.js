...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WalletTypeEcm', function() {
      beforeEach(function() {
        instance = FinacApi.WalletTypeEcm;
      });

      it('should create an instance of WalletTypeEcm', function() {
        // TODO: update the code to test WalletTypeEcm
