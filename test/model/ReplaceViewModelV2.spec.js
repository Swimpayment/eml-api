...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ReplaceViewModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.ReplaceViewModelV2();
      });

      it('should create an instance of ReplaceViewModelV2', function() {
        // TODO: update the code to test ReplaceViewModelV2
        expect(instance).to.be.a(FinacApi.ReplaceViewModelV2);
      });
