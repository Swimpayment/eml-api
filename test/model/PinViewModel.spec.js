...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PinViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.PinViewModel();
      });

      it('should create an instance of PinViewModel', function() {
        // TODO: update the code to test PinViewModel
        expect(instance).to.be.a(FinacApi.PinViewModel);
      });
