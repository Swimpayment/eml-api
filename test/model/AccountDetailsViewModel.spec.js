...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountDetailsViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.AccountDetailsViewModel();
      });

      it('should create an instance of AccountDetailsViewModel', function() {
        // TODO: update the code to test AccountDetailsViewModel
        expect(instance).to.be.a(FinacApi.AccountDetailsViewModel);
      });
