...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EcmSpendControlGroup', function() {
      beforeEach(function() {
        instance = new FinacApi.EcmSpendControlGroup();
      });

      it('should create an instance of EcmSpendControlGroup', function() {
        // TODO: update the code to test EcmSpendControlGroup
        expect(instance).to.be.a(FinacApi.EcmSpendControlGroup);
      });
