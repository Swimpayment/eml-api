...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PinBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.PinBindingModel();
      });

      it('should create an instance of PinBindingModel', function() {
        // TODO: update the code to test PinBindingModel
        expect(instance).to.be.a(FinacApi.PinBindingModel);
      });
