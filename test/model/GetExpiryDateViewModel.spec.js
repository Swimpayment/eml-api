...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetExpiryDateViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetExpiryDateViewModel();
      });

      it('should create an instance of GetExpiryDateViewModel', function() {
        // TODO: update the code to test GetExpiryDateViewModel
        expect(instance).to.be.a(FinacApi.GetExpiryDateViewModel);
      });
