...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankPaymentCreditorType', function() {
      beforeEach(function() {
        instance = FinacApi.BankPaymentCreditorType;
      });

      it('should create an instance of BankPaymentCreditorType', function() {
        // TODO: update the code to test BankPaymentCreditorType
