...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountUpdateBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.AccountUpdateBindingModel();
      });

      it('should create an instance of AccountUpdateBindingModel', function() {
        // TODO: update the code to test AccountUpdateBindingModel
        expect(instance).to.be.a(FinacApi.AccountUpdateBindingModel);
      });
      ...
      it('should have the property secondaryState (base name: "secondaryState")', function() {
        // TODO: update the code to test the property secondaryState
        expect(instance).to.have.property('secondaryState');
        // expect(instance.secondaryState).to.be(expectedValueLiteral);
      });
