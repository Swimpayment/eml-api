...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConditionConfiguration', function() {
      beforeEach(function() {
        instance = new FinacApi.ConditionConfiguration();
      });

      it('should create an instance of ConditionConfiguration', function() {
        // TODO: update the code to test ConditionConfiguration
        expect(instance).to.be.a(FinacApi.ConditionConfiguration);
      });
