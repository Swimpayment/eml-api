...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KycLinkBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.KycLinkBindingModel();
      });

      it('should create an instance of KycLinkBindingModel', function() {
        // TODO: update the code to test KycLinkBindingModel
        expect(instance).to.be.a(FinacApi.KycLinkBindingModel);
      });
