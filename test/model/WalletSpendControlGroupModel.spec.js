...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WalletSpendControlGroupModel', function() {
      beforeEach(function() {
        instance = new FinacApi.WalletSpendControlGroupModel();
      });

      it('should create an instance of WalletSpendControlGroupModel', function() {
        // TODO: update the code to test WalletSpendControlGroupModel
        expect(instance).to.be.a(FinacApi.WalletSpendControlGroupModel);
      });
