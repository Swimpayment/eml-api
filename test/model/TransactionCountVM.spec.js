...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TransactionCountVM', function() {
      beforeEach(function() {
        instance = new FinacApi.TransactionCountVM();
      });

      it('should create an instance of TransactionCountVM', function() {
        // TODO: update the code to test TransactionCountVM
        expect(instance).to.be.a(FinacApi.TransactionCountVM);
      });
