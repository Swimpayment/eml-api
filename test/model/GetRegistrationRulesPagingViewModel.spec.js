...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetRegistrationRulesPagingViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetRegistrationRulesPagingViewModel();
      });

      it('should create an instance of GetRegistrationRulesPagingViewModel', function() {
        // TODO: update the code to test GetRegistrationRulesPagingViewModel
        expect(instance).to.be.a(FinacApi.GetRegistrationRulesPagingViewModel);
      });
