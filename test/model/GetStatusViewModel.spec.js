...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetStatusViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetStatusViewModel();
      });

      it('should create an instance of GetStatusViewModel', function() {
        // TODO: update the code to test GetStatusViewModel
        expect(instance).to.be.a(FinacApi.GetStatusViewModel);
      });
