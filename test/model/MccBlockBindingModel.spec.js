...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MccBlockBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.MccBlockBindingModel();
      });

      it('should create an instance of MccBlockBindingModel', function() {
        // TODO: update the code to test MccBlockBindingModel
        expect(instance).to.be.a(FinacApi.MccBlockBindingModel);
      });
      ...
      it('should have the property mccGroup (base name: "mccGroup")', function() {
        // TODO: update the code to test the property mccGroup
        expect(instance).to.have.property('mccGroup');
        // expect(instance.mccGroup).to.be(expectedValueLiteral);
      });
