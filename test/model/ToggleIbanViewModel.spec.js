...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ToggleIbanViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.ToggleIbanViewModel();
      });

      it('should create an instance of ToggleIbanViewModel', function() {
        // TODO: update the code to test ToggleIbanViewModel
        expect(instance).to.be.a(FinacApi.ToggleIbanViewModel);
      });
