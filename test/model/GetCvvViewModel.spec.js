...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCvvViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetCvvViewModel();
      });

      it('should create an instance of GetCvvViewModel', function() {
        // TODO: update the code to test GetCvvViewModel
        expect(instance).to.be.a(FinacApi.GetCvvViewModel);
      });
