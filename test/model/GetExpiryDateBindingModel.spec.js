...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetExpiryDateBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetExpiryDateBindingModel();
      });

      it('should create an instance of GetExpiryDateBindingModel', function() {
        // TODO: update the code to test GetExpiryDateBindingModel
        expect(instance).to.be.a(FinacApi.GetExpiryDateBindingModel);
      });
