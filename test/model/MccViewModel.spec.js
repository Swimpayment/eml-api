...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MccViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.MccViewModel();
      });

      it('should create an instance of MccViewModel', function() {
        // TODO: update the code to test MccViewModel
        expect(instance).to.be.a(FinacApi.MccViewModel);
      });
