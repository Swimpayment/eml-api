...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeletePayeeBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.DeletePayeeBindingModel();
      });

      it('should create an instance of DeletePayeeBindingModel', function() {
        // TODO: update the code to test DeletePayeeBindingModel
        expect(instance).to.be.a(FinacApi.DeletePayeeBindingModel);
      });
