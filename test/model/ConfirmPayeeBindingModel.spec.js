...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ConfirmPayeeBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.ConfirmPayeeBindingModel();
      });

      it('should create an instance of ConfirmPayeeBindingModel', function() {
        // TODO: update the code to test ConfirmPayeeBindingModel
        expect(instance).to.be.a(FinacApi.ConfirmPayeeBindingModel);
      });
