...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpgradeCardBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.UpgradeCardBindingModel();
      });

      it('should create an instance of UpgradeCardBindingModel', function() {
        // TODO: update the code to test UpgradeCardBindingModel
        expect(instance).to.be.a(FinacApi.UpgradeCardBindingModel);
      });
