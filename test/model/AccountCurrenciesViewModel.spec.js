...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountCurrenciesViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.AccountCurrenciesViewModel();
      });

      it('should create an instance of AccountCurrenciesViewModel', function() {
        // TODO: update the code to test AccountCurrenciesViewModel
        expect(instance).to.be.a(FinacApi.AccountCurrenciesViewModel);
      });
