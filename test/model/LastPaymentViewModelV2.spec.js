...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LastPaymentViewModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.LastPaymentViewModelV2();
      });

      it('should create an instance of LastPaymentViewModelV2', function() {
        // TODO: update the code to test LastPaymentViewModelV2
        expect(instance).to.be.a(FinacApi.LastPaymentViewModelV2);
      });
