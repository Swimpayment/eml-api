...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateRiskLevelBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.UpdateRiskLevelBindingModel();
      });

      it('should create an instance of UpdateRiskLevelBindingModel', function() {
        // TODO: update the code to test UpdateRiskLevelBindingModel
        expect(instance).to.be.a(FinacApi.UpdateRiskLevelBindingModel);
      });
