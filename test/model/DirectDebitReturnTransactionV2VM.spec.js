...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DirectDebitReturnTransactionV2VM', function() {
      beforeEach(function() {
        instance = new FinacApi.DirectDebitReturnTransactionV2VM();
      });

      it('should create an instance of DirectDebitReturnTransactionV2VM', function() {
        // TODO: update the code to test DirectDebitReturnTransactionV2VM
        expect(instance).to.be.a(FinacApi.DirectDebitReturnTransactionV2VM);
      });
      ...
      it('should have the property prvtReference (base name: "prvtReference")', function() {
        // TODO: update the code to test the property prvtReference
        expect(instance).to.have.property('prvtReference');
        // expect(instance.prvtReference).to.be(expectedValueLiteral);
      });
