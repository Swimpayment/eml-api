...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserRegistrationType', function() {
      beforeEach(function() {
        instance = FinacApi.UserRegistrationType;
      });

      it('should create an instance of UserRegistrationType', function() {
        // TODO: update the code to test UserRegistrationType
