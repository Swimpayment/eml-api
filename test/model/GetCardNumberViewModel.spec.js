...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCardNumberViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetCardNumberViewModel();
      });

      it('should create an instance of GetCardNumberViewModel', function() {
        // TODO: update the code to test GetCardNumberViewModel
        expect(instance).to.be.a(FinacApi.GetCardNumberViewModel);
      });
