...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetPayeeBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetPayeeBindingModel();
      });

      it('should create an instance of GetPayeeBindingModel', function() {
        // TODO: update the code to test GetPayeeBindingModel
        expect(instance).to.be.a(FinacApi.GetPayeeBindingModel);
      });
