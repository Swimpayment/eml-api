...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PurchaseOnUsBindingModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.PurchaseOnUsBindingModelV2();
      });

      it('should create an instance of PurchaseOnUsBindingModelV2', function() {
        // TODO: update the code to test PurchaseOnUsBindingModelV2
        expect(instance).to.be.a(FinacApi.PurchaseOnUsBindingModelV2);
      });
