...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PhysicalCardBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.PhysicalCardBindingModel();
      });

      it('should create an instance of PhysicalCardBindingModel', function() {
        // TODO: update the code to test PhysicalCardBindingModel
        expect(instance).to.be.a(FinacApi.PhysicalCardBindingModel);
      });
