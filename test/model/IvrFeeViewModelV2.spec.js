...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IvrFeeViewModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.IvrFeeViewModelV2();
      });

      it('should create an instance of IvrFeeViewModelV2', function() {
        // TODO: update the code to test IvrFeeViewModelV2
        expect(instance).to.be.a(FinacApi.IvrFeeViewModelV2);
      });
