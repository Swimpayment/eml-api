...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BalanceV2ViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.BalanceV2ViewModel();
      });

      it('should create an instance of BalanceV2ViewModel', function() {
        // TODO: update the code to test BalanceV2ViewModel
        expect(instance).to.be.a(FinacApi.BalanceV2ViewModel);
      });
