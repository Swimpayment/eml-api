...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InquiryV2ViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.InquiryV2ViewModel();
      });

      it('should create an instance of InquiryV2ViewModel', function() {
        // TODO: update the code to test InquiryV2ViewModel
        expect(instance).to.be.a(FinacApi.InquiryV2ViewModel);
      });
