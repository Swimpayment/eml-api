...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TokenTransactionsViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.TokenTransactionsViewModel();
      });

      it('should create an instance of TokenTransactionsViewModel', function() {
        // TODO: update the code to test TokenTransactionsViewModel
        expect(instance).to.be.a(FinacApi.TokenTransactionsViewModel);
      });
