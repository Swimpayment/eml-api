...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InvalidResponsePackage', function() {
      beforeEach(function() {
        instance = new FinacApi.InvalidResponsePackage();
      });

      it('should create an instance of InvalidResponsePackage', function() {
        // TODO: update the code to test InvalidResponsePackage
        expect(instance).to.be.a(FinacApi.InvalidResponsePackage);
      });
