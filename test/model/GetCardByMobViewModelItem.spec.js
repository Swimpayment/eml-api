...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetCardByMobViewModelItem', function() {
      beforeEach(function() {
        instance = new FinacApi.GetCardByMobViewModelItem();
      });

      it('should create an instance of GetCardByMobViewModelItem', function() {
        // TODO: update the code to test GetCardByMobViewModelItem
        expect(instance).to.be.a(FinacApi.GetCardByMobViewModelItem);
      });
