...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RecurringBankPaymentFrequencyMethod', function() {
      beforeEach(function() {
        instance = FinacApi.RecurringBankPaymentFrequencyMethod;
      });

      it('should create an instance of RecurringBankPaymentFrequencyMethod', function() {
        // TODO: update the code to test RecurringBankPaymentFrequencyMethod
