...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LoadLimitsBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.LoadLimitsBindingModel();
      });

      it('should create an instance of LoadLimitsBindingModel', function() {
        // TODO: update the code to test LoadLimitsBindingModel
        expect(instance).to.be.a(FinacApi.LoadLimitsBindingModel);
      });
