...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankPaymentDirection', function() {
      beforeEach(function() {
        instance = FinacApi.BankPaymentDirection;
      });

      it('should create an instance of BankPaymentDirection', function() {
        // TODO: update the code to test BankPaymentDirection
