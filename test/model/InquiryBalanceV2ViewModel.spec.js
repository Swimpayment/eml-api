...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('InquiryBalanceV2ViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.InquiryBalanceV2ViewModel();
      });

      it('should create an instance of InquiryBalanceV2ViewModel', function() {
        // TODO: update the code to test InquiryBalanceV2ViewModel
        expect(instance).to.be.a(FinacApi.InquiryBalanceV2ViewModel);
      });
