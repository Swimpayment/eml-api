...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupNameMccViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GroupNameMccViewModel();
      });

      it('should create an instance of GroupNameMccViewModel', function() {
        // TODO: update the code to test GroupNameMccViewModel
        expect(instance).to.be.a(FinacApi.GroupNameMccViewModel);
      });
