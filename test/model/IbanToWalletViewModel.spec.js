...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('IbanToWalletViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.IbanToWalletViewModel();
      });

      it('should create an instance of IbanToWalletViewModel', function() {
        // TODO: update the code to test IbanToWalletViewModel
        expect(instance).to.be.a(FinacApi.IbanToWalletViewModel);
      });
