...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateSpendControlGroupBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.CreateSpendControlGroupBindingModel();
      });

      it('should create an instance of CreateSpendControlGroupBindingModel', function() {
        // TODO: update the code to test CreateSpendControlGroupBindingModel
        expect(instance).to.be.a(FinacApi.CreateSpendControlGroupBindingModel);
      });
