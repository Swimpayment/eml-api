...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CardLinkingBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.CardLinkingBindingModel();
      });

      it('should create an instance of CardLinkingBindingModel', function() {
        // TODO: update the code to test CardLinkingBindingModel
        expect(instance).to.be.a(FinacApi.CardLinkingBindingModel);
      });
