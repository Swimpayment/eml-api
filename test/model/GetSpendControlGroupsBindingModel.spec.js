...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetSpendControlGroupsBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetSpendControlGroupsBindingModel();
      });

      it('should create an instance of GetSpendControlGroupsBindingModel', function() {
        // TODO: update the code to test GetSpendControlGroupsBindingModel
        expect(instance).to.be.a(FinacApi.GetSpendControlGroupsBindingModel);
      });
