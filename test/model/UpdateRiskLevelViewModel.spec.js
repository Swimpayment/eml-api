...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateRiskLevelViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.UpdateRiskLevelViewModel();
      });

      it('should create an instance of UpdateRiskLevelViewModel', function() {
        // TODO: update the code to test UpdateRiskLevelViewModel
        expect(instance).to.be.a(FinacApi.UpdateRiskLevelViewModel);
      });
