...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('JwtTokenValidResponsePackage', function() {
      beforeEach(function() {
        instance = new FinacApi.JwtTokenValidResponsePackage();
      });

      it('should create an instance of JwtTokenValidResponsePackage', function() {
        // TODO: update the code to test JwtTokenValidResponsePackage
        expect(instance).to.be.a(FinacApi.JwtTokenValidResponsePackage);
      });
