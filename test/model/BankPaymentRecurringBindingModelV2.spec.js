...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankPaymentRecurringBindingModelV2', function() {
      beforeEach(function() {
        instance = new FinacApi.BankPaymentRecurringBindingModelV2();
      });

      it('should create an instance of BankPaymentRecurringBindingModelV2', function() {
        // TODO: update the code to test BankPaymentRecurringBindingModelV2
        expect(instance).to.be.a(FinacApi.BankPaymentRecurringBindingModelV2);
      });
