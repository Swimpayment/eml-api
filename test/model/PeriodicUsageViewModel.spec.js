...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PeriodicUsageViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.PeriodicUsageViewModel();
      });

      it('should create an instance of PeriodicUsageViewModel', function() {
        // TODO: update the code to test PeriodicUsageViewModel
        expect(instance).to.be.a(FinacApi.PeriodicUsageViewModel);
      });
