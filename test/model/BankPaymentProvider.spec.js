...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BankPaymentProvider', function() {
      beforeEach(function() {
        instance = FinacApi.BankPaymentProvider;
      });

      it('should create an instance of BankPaymentProvider', function() {
        // TODO: update the code to test BankPaymentProvider
