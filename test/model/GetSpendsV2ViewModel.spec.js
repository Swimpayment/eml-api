...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetSpendsV2ViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetSpendsV2ViewModel();
      });

      it('should create an instance of GetSpendsV2ViewModel', function() {
        // TODO: update the code to test GetSpendsV2ViewModel
        expect(instance).to.be.a(FinacApi.GetSpendsV2ViewModel);
      });
