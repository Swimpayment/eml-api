...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateSecurityDetailsThreeDSBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.UpdateSecurityDetailsThreeDSBindingModel();
      });

      it('should create an instance of UpdateSecurityDetailsThreeDSBindingModel', function() {
        // TODO: update the code to test UpdateSecurityDetailsThreeDSBindingModel
        expect(instance).to.be.a(FinacApi.UpdateSecurityDetailsThreeDSBindingModel);
      });
