...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetRiskLevelViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.GetRiskLevelViewModel();
      });

      it('should create an instance of GetRiskLevelViewModel', function() {
        // TODO: update the code to test GetRiskLevelViewModel
        expect(instance).to.be.a(FinacApi.GetRiskLevelViewModel);
      });
