...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountDetailsAccountInfoViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.AccountDetailsAccountInfoViewModel();
      });

      it('should create an instance of AccountDetailsAccountInfoViewModel', function() {
        // TODO: update the code to test AccountDetailsAccountInfoViewModel
        expect(instance).to.be.a(FinacApi.AccountDetailsAccountInfoViewModel);
      });
