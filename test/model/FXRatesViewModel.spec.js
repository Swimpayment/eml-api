...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FXRatesViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.FXRatesViewModel();
      });

      it('should create an instance of FXRatesViewModel', function() {
        // TODO: update the code to test FXRatesViewModel
        expect(instance).to.be.a(FinacApi.FXRatesViewModel);
      });
