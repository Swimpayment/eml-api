...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KycRedeemCodeViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.KycRedeemCodeViewModel();
      });

      it('should create an instance of KycRedeemCodeViewModel', function() {
        // TODO: update the code to test KycRedeemCodeViewModel
        expect(instance).to.be.a(FinacApi.KycRedeemCodeViewModel);
      });
