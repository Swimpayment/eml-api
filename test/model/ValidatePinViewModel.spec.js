...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ValidatePinViewModel', function() {
      beforeEach(function() {
        instance = new FinacApi.ValidatePinViewModel();
      });

      it('should create an instance of ValidatePinViewModel', function() {
        // TODO: update the code to test ValidatePinViewModel
        expect(instance).to.be.a(FinacApi.ValidatePinViewModel);
      });
