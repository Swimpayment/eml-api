...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DirectDebitOutgoingReturnBindingModel', function() {
      beforeEach(function() {
        instance = new FinacApi.DirectDebitOutgoingReturnBindingModel();
      });

      it('should create an instance of DirectDebitOutgoingReturnBindingModel', function() {
        // TODO: update the code to test DirectDebitOutgoingReturnBindingModel
        expect(instance).to.be.a(FinacApi.DirectDebitOutgoingReturnBindingModel);
      });
