...
exports.GetCvvBindingModel = void 0;
 ...
 * @version 2.0
 */
var GetCvvBindingModel = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function GetCvvBindingModel() {
    _classCallCheck(this, GetCvvBindingModel);
  }
   ...
   */
  _createClass(GetCvvBindingModel, null, [{
  ...
  return GetCvvBindingModel;
}();
/**
 * Primary cardholder phone.
 * @member {String} phone
 */
exports.GetCvvBindingModel = GetCvvBindingModel;
