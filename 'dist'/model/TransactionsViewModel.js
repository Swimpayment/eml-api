...
exports.TransactionsViewModel = void 0;
var _ApiClient = require("../ApiClient");
var _PagingViewModel = require("./PagingViewModel");
var _TransactionViewModel = require("./TransactionViewModel");
 ...
 * @version 2.0
 */
var TransactionsViewModel = /*#__PURE__*/function () {
  /**
  ...
  function TransactionsViewModel() {
    _classCallCheck(this, TransactionsViewModel);
  }
   ...
   */
  _createClass(TransactionsViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TransactionsViewModel();
        if (data.hasOwnProperty('transactions')) obj.transactions = _ApiClient.ApiClient.convertToType(data['transactions'], [_TransactionViewModel.TransactionViewModel]);
        if (data.hasOwnProperty('apiVersion')) obj.apiVersion = _ApiClient.ApiClient.convertToType(data['apiVersion'], 'Number');
        if (data.hasOwnProperty('mainCurrency')) obj.mainCurrency = _ApiClient.ApiClient.convertToType(data['mainCurrency'], 'String');
        if (data.hasOwnProperty('transactionCount')) obj.transactionCount = _ApiClient.ApiClient.convertToType(data['transactionCount'], 'Number');
        if (data.hasOwnProperty('paging')) obj.paging = _PagingViewModel.PagingViewModel.constructFromObject(data['paging']);
      }
      return obj;
    }
  }]);
 ...
 */
exports.TransactionsViewModel = TransactionsViewModel;
