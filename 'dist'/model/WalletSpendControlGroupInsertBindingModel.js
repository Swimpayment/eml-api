...
exports.WalletSpendControlGroupInsertBindingModel = void 0;
 ...
 * @version 2.0
 */
var WalletSpendControlGroupInsertBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function WalletSpendControlGroupInsertBindingModel(bin, distributorCode, groupName, groupSettings) {
    _classCallCheck(this, WalletSpendControlGroupInsertBindingModel);
    this.bin = bin;
   ...
   */
  _createClass(WalletSpendControlGroupInsertBindingModel, null, [{
  ...
  return WalletSpendControlGroupInsertBindingModel;
}();
/**
 * Assigned by PFS. It is the first 8 digits of the cards on your program.
 * @member {String} bin
 */
exports.WalletSpendControlGroupInsertBindingModel = WalletSpendControlGroupInsertBindingModel;
