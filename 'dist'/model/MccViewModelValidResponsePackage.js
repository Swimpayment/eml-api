...
exports.MccViewModelValidResponsePackage = void 0;
var _ApiClient = require("../ApiClient");
var _MccViewModel = require("./MccViewModel");
 ...
 * @version 2.0
 */
var MccViewModelValidResponsePackage = /*#__PURE__*/function () {
  /**
   ...
   * @class
   */
  function MccViewModelValidResponsePackage() {
    _classCallCheck(this, MccViewModelValidResponsePackage);
  }
   ...
   */
  _createClass(MccViewModelValidResponsePackage, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new MccViewModelValidResponsePackage();
        if (data.hasOwnProperty('data')) obj.data = _MccViewModel.MccViewModel.constructFromObject(data['data']);
        if (data.hasOwnProperty('referenceId')) obj.referenceId = _ApiClient.ApiClient.convertToType(data['referenceId'], 'Number');
      }
      return obj;
    }
  }]);
  return MccViewModelValidResponsePackage;
}();
/**
 * @member {module:model/MccViewModel} data
 */
exports.MccViewModelValidResponsePackage = MccViewModelValidResponsePackage;
