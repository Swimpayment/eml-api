...
exports.TransactionViewModel = void 0;
 ...
 * @version 2.0
 */
var TransactionViewModel = /*#__PURE__*/function () {
  /**
  ...
  function TransactionViewModel() {
    _classCallCheck(this, TransactionViewModel);
  }
   ...
   */
  _createClass(TransactionViewModel, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('transactionType')) obj.transactionType = _ApiClient.ApiClient.convertToType(data['transactionType'], 'String');
        if (data.hasOwnProperty('cardType')) obj.cardType = _ApiClient.ApiClient.convertToType(data['cardType'], 'String');
        if (data.hasOwnProperty('mti')) obj.mti = _ApiClient.ApiClient.convertToType(data['mti'], 'String');
        if (data.hasOwnProperty('arn')) obj.arn = _ApiClient.ApiClient.convertToType(data['arn'], 'String');
        if (data.hasOwnProperty('stn')) obj.stn = _ApiClient.ApiClient.convertToType(data['stn'], 'String');
        if (data.hasOwnProperty('authenticationNumber')) obj.authenticationNumber = _ApiClient.ApiClient.convertToType(data['authenticationNumber'], 'String');
        if (data.hasOwnProperty('recordType')) obj.recordType = _ApiClient.ApiClient.convertToType(data['recordType'], 'String');
        if (data.hasOwnProperty('transactionOrigin')) obj.transactionOrigin = _ApiClient.ApiClient.convertToType(data['transactionOrigin'], 'String');
        ...
        if (data.hasOwnProperty('fee')) obj.fee = _ApiClient.ApiClient.convertToType(data['fee'], 'String');
        if (data.hasOwnProperty('availableBalance')) obj.availableBalance = _ApiClient.ApiClient.convertToType(data['availableBalance'], 'String');
        if (data.hasOwnProperty('ledgerBalance')) obj.ledgerBalance = _ApiClient.ApiClient.convertToType(data['ledgerBalance'], 'String');
        if (data.hasOwnProperty('clientId')) obj.clientId = _ApiClient.ApiClient.convertToType(data['clientId'], 'String');
        ...
        if (data.hasOwnProperty('terminalCountry')) obj.terminalCountry = _ApiClient.ApiClient.convertToType(data['terminalCountry'], 'String');
        if (data.hasOwnProperty('terminalCurrency')) obj.terminalCurrency = _ApiClient.ApiClient.convertToType(data['terminalCurrency'], 'String');
        if (data.hasOwnProperty('mcc')) obj.mcc = _ApiClient.ApiClient.convertToType(data['mcc'], 'String');
        if (data.hasOwnProperty('surcharge')) obj.surcharge = _ApiClient.ApiClient.convertToType(data['surcharge'], 'String');
        if (data.hasOwnProperty('issuerFee')) obj.issuerFee = _ApiClient.ApiClient.convertToType(data['issuerFee'], 'String');
        if (data.hasOwnProperty('responseCode')) obj.responseCode = _ApiClient.ApiClient.convertToType(data['responseCode'], 'String');
        if (data.hasOwnProperty('foreignExchangeFee')) obj.foreignExchangeFee = _ApiClient.ApiClient.convertToType(data['foreignExchangeFee'], 'String');
        if (data.hasOwnProperty('currency')) obj.currency = _ApiClient.ApiClient.convertToType(data['currency'], 'String');
        if (data.hasOwnProperty('transactionCodeDescription')) obj.transactionCodeDescription = _ApiClient.ApiClient.convertToType(data['transactionCodeDescription'], 'String');
        if (data.hasOwnProperty('transactionResult')) obj.transactionResult = _ApiClient.ApiClient.convertToType(data['transactionResult'], 'String');
        if (data.hasOwnProperty('originalTransactionAmount')) obj.originalTransactionAmount = _ApiClient.ApiClient.convertToType(data['originalTransactionAmount'], 'String');
        if (data.hasOwnProperty('conversionRate')) obj.conversionRate = _ApiClient.ApiClient.convertToType(data['conversionRate'], 'Number');
        if (data.hasOwnProperty('originalHoldAmount')) obj.originalHoldAmount = _ApiClient.ApiClient.convertToType(data['originalHoldAmount'], 'String');
        if (data.hasOwnProperty('cardAcceptorIdCode')) obj.cardAcceptorIdCode = _ApiClient.ApiClient.convertToType(data['cardAcceptorIdCode'], 'String');
        if (data.hasOwnProperty('actionCodeDescription')) obj.actionCodeDescription = _ApiClient.ApiClient.convertToType(data['actionCodeDescription'], 'String');
        if (data.hasOwnProperty('acquiringInstitution')) obj.acquiringInstitution = _ApiClient.ApiClient.convertToType(data['acquiringInstitution'], 'String');
        if (data.hasOwnProperty('processor')) obj.processor = _ApiClient.ApiClient.convertToType(data['processor'], 'String');
        if (data.hasOwnProperty('posEntryMode')) obj.posEntryMode = _ApiClient.ApiClient.convertToType(data['posEntryMode'], 'String');
        if (data.hasOwnProperty('atmFee')) obj.atmFee = _ApiClient.ApiClient.convertToType(data['atmFee'], 'String');
        if (data.hasOwnProperty('walletProvider')) obj.walletProvider = _ApiClient.ApiClient.convertToType(data['walletProvider'], 'String');
        if (data.hasOwnProperty('cardId')) obj.cardId = _ApiClient.ApiClient.convertToType(data['cardId'], 'String');
        if (data.hasOwnProperty('walletId')) obj.walletId = _ApiClient.ApiClient.convertToType(data['walletId'], 'String');
        if (data.hasOwnProperty('uniqueReference')) obj.uniqueReference = _ApiClient.ApiClient.convertToType(data['uniqueReference'], 'String');
      }
      return obj;
    }
  }]);
