...
exports.ConditionGroupInsertBindingModel = void 0;
 ...
 * @version 2.0
 */
var ConditionGroupInsertBindingModel = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConditionGroupInsertBindingModel(bin, dc, name) {
    _classCallCheck(this, ConditionGroupInsertBindingModel);
    this.bin = bin;
    this.dc = dc;
    this.name = name;
  }
   ...
   */
  _createClass(ConditionGroupInsertBindingModel, null, [{
  ...
  return ConditionGroupInsertBindingModel;
}();
/**
 * Assigned by PFS. It is the first 8 digits of the cards on your program.
 * @member {String} bin
 */
exports.ConditionGroupInsertBindingModel = ConditionGroupInsertBindingModel;
