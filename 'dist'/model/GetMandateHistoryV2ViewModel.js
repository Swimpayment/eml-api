...
exports.GetMandateHistoryV2ViewModel = void 0;
var _ApiClient = require("../ApiClient");
var _MandateHistoryResponseV2VM = require("./MandateHistoryResponseV2VM");
 ...
 * @version 2.0
 */
var GetMandateHistoryV2ViewModel = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>GetMandateHistoryV2ViewModel</code>.
   * @alias module:model/GetMandateHistoryV2ViewModel
   * @class
   */
  function GetMandateHistoryV2ViewModel() {
    _classCallCheck(this, GetMandateHistoryV2ViewModel);
  }
   ...
   */
  _createClass(GetMandateHistoryV2ViewModel, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new GetMandateHistoryV2ViewModel();
        if (data.hasOwnProperty('mandateHistory')) obj.mandateHistory = _ApiClient.ApiClient.convertToType(data['mandateHistory'], [_MandateHistoryResponseV2VM.MandateHistoryResponseV2VM]);
      }
      return obj;
    }
  }]);
  return GetMandateHistoryV2ViewModel;
}();
/**
 * @member {Array.<module:model/MandateHistoryResponseV2VM>} mandateHistory
 */
exports.GetMandateHistoryV2ViewModel = GetMandateHistoryV2ViewModel;
