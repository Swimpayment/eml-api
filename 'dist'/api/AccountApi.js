...
var AccountApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(AccountApi, [{
    ...
    /**
     * Callback function to receive the result of the apiAccountIdBalanceCreditPost operation.
     * @callback moduleapi/AccountApi~apiAccountIdBalanceCreditPostCallback
     * @param {String} error Error message, if any.
     * @param {module:model/DepositViewModelV2ValidResponsePackage{ data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} fOrigin Origin of request
     * @param {Object} opts Optional parameters
     * @param {module:model/DepositBindingModelV2} opts.body Request body, see details under the &#x27;Model&#x27; tab
     * @param {module:api/AccountApi~apiAccountIdBalanceCreditPostCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link <&vendorExtensions.x-jsdoc-type>}
     */
  }, {
    key: "apiAccountIdBalanceCreditPost",
    value: function apiAccountIdBalanceCreditPost(id, apiVersion, authorization, fMessageId, fOrigin, opts, callback) {
      opts = opts || {};
      var postBody = opts['body'];
      // verify the required parameter 'id' is set
      if (id === undefined || id === null) {
        throw new Error("Missing the required parameter 'id' when calling apiAccountIdBalanceCreditPost");
      }
      // verify the required parameter 'apiVersion' is set
      if (apiVersion === undefined || apiVersion === null) {
        throw new Error("Missing the required parameter 'apiVersion' when calling apiAccountIdBalanceCreditPost");
      }
      // verify the required parameter 'authorization' is set
      if (authorization === undefined || authorization === null) {
        throw new Error("Missing the required parameter 'authorization' when calling apiAccountIdBalanceCreditPost");
      }
      // verify the required parameter 'fMessageId' is set
      if (fMessageId === undefined || fMessageId === null) {
        throw new Error("Missing the required parameter 'fMessageId' when calling apiAccountIdBalanceCreditPost");
      }
      // verify the required parameter 'fOrigin' is set
      if (fOrigin === undefined || fOrigin === null) {
        throw new Error("Missing the required parameter 'fOrigin' when calling apiAccountIdBalanceCreditPost");
      }
      var pathParams = {
        'Id': id
      };
      ...
      var contentTypes = ['application/json'];
      var accepts = ['application/json'];
      var returnType = _DepositViewModelV2ValidResponsePackage.DepositViewModelV2ValidResponsePackage;
      return this.apiClient.callApi('/api/Account/{Id}/Balance/Credit', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, callback);
    }
    /**
     ...
     * @param {Boolean} opts.newestFirst This is used to invert the order of returned transactions so that if the requester needs to show the most recent transaction to their cardholders they will set this to true.
